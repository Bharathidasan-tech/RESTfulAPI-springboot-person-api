package com.personapi.common.constant;

/**
 * The Class PersonConstant.
 *
...
public class PersonConstant {
	...
	public static final String DELETE_SUCCESS_MSG="Person details has been deleted successfully";
